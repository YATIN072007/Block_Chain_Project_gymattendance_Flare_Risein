...
<img width="1280" height="800" alt="image" src="https://github.com/user-attachments/assets/2eb1b2b7-3174-4208-9a4c-772019c2b754" />

---

## Description

Gym Attendance is a decentralized application (DApp) designed to record and track gym check-ins on the blockchain. Each time a user marks their attendance, their wallet address and timestamp are permanently stored on-chain, creating a tamper-proof and transparent attendance record system.

This project eliminates the need for traditional centralized attendance systems and replaces them with a trustless, verifiable, and immutable ledger of gym visits.
